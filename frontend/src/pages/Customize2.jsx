...
setLoading(false)
  ...
  return (
    <div className='w-full min-h-screen bg-gradient-to-r from-blue-700 via-purple-700 to-indigo-700 flex justify-center items-center flex-col p-[20px] relative '>
      ...
      <h1 className='text-white text-[30px] font-semibold mb-[40px] transition-colors duration-500 hover:text-blue-500 text-center '>Enter Your <span className='text-blue-200'>Assistant Name</span> </h1>
